					...
					<tbody>
						<tr>
							<td class="cart_product">
								<a href=""><img src="imagesOut/cart/one.png" alt=""></a>
							</td>
							...
							<td class="cart_quantity" style="vertical-align:middle;text-align:center;">
								<div class="cart_quantity_button">
									...
									<input onkeypress="return solonumerosCarr(event);" name="quantity" maxlength="2" class="cart_quantity_input" type="text" value="1"  size="2" id="cantidad">
						...
						<div class="chose_area">
							<ul class="user_option">
								<li>
									...
									<label>Recoger en el Local de la Empresa</label>
								</li>
								
								<li>
									<input type="radio" name="entrega" value="casa" >
		...
		<div class="container">
			...
			<div id="formuCasa" style="display:none;">
				...
				<div class="step2" style="display:none;">
					<!-- CUADRO FECHAS-->
					<div  style="border: 2px solid #ffbf00; border-radius: 8px;padding:15px;height:150px;" class="col-xs-4 col-sm-4">
						<p>Fechas disponibles</p>
						<form>
							<input type="radio" name="fecha"> 25/10/16 <br>
							<input type="radio" name="fecha"> 26/10/16 <br>
							<input type="radio" name="fecha"> 28/10/16
						</form>
					</div>
					<!-- SEGUNDO CUADRO-->
					<div class="col-xs-2 col-sm-2"></div>
					<div style="border: 2px solid #ffbf00; border-radius: 8px;padding:15px;height:auto;" class="col-xs-6 col-sm-6">
						<label>Sub-Total :</label>&nbsp; <label>S/.160.00</label><br>							<label class="pagenv">Pag. Envio :</label>&nbsp;  <label id="valEnv" class="pagenv">----</label><br>
						<label>Descuento :</label>&nbsp; <label>S/.0.00</label> <br>
						<label>Tot. Pagar :</label>&nbsp; <label>S/.170.00</label> 
					</div>
				</div>
				<!-- DIRECCION DE ENVIO -->
				<div class="step3" style="display:none;">
					<div class="col-xs-12 col-sm-12 " style="margin-top:25px;" id="infoDirEnv">
						...
						<div class="col-xs-8 col-sm-8" >
							<label id="mosNom"></label><br>
							<label id="mosDir"></label><br>
							<label id="mosDis"></label><br>
							<label id="mosTel"></label>
						</div>
					</div>
				</div>
				<!-- TIPO DE PAGO-->
				...
				<div class="step2" style="display:none;">
					<div class="col-xs-12 col-sm-12" style="margin-top:25px;">
						...
						<div class="col-xs-4 col-sm-4">
							<a href="">
								<img src="images/paypal.png"  class="img-responsive" style="height:100px;width:150px;">
							</a>
						</div>
					</div>
				</div>
