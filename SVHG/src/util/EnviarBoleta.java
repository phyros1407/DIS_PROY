	...
	public  String armarEmail(){
		...
		String cuerpo =
				"<!DOCTYPE html>                                                                                                                                                                                                                                                 "+
						...
						"			    	<tr>                                                                                                                                                                                                                                         "+
						"			    		<td>                                                                                                                                                                                                                                     "+
						"			    			<table align='left' style='text-align: left;padding: 20px 0 ;' width='300px' cellpadding='0' cellspacing='0' border='0' class='responsive-table-2'>                                                                                  "+
						"			    				<tr>                                                                                                                                                                                                                             "+
						"			    					<td>                                                                                                                                                                                                                         "+
						...
						"						    				<label>FECHA DE ENTREGA DE PEDIDO : </label><label></label><br>                                                                                                                                                    "+
						"						    			</fieldset>                                                                                                                                                                                                              "+
						"			    					</td>                                                                                                                                                                                                                        "+
						"			    				</tr>                                                                                                                                                                                                                            "+
						"			    			</table>                                                                                                                                                                                                                             "+
						"			    			<table align='right' width='300px' cellpadding='0' cellspacing='0' border='0' class='responsive-table-2' style='text-align: left;padding: 20px 0 ;'>                                                                                 "+
						"			    				<tr>                                                                                                                                                                                                                             "+
						"			    					<td>                                                                                                                                                                                                                         "+
						"			    						<fieldset style='border:3px solid;border-radius: 8px;'>                                                                                                                                                                  "+
