		...
		try {
			...
			if(filas>0){
				...
				for(int i=1;i<=productoId.length;i++){
					...
					String query1="insert into detalle_oferta(OFE_ID,PRO_ID,USU_CREA_REGI,FEC_CREA_REGI,ULT_USU_MOD_REGI,FEC_ULT_MOD_REGI)"
							+"VALUES("+maxId+","+productoId[i-1]+",'USER','2016-09-29 11:01:16','USER','2016-09-29 11:01:16');";
