	...
	public boolean guardarPedido(PedidoBean pedido) throws Exception {
		...
		try{
			...
			String query = " INSERT INTO pedido (PED_ID,TIP_ENT,TIPO_PAG,DEP_ENT,PRO_ENT,DIS_ENT,DIR_ENT,REF,TEL_REF_1,TEL_REF_2,EST_ENT,CUO,CAR_ENT) "
					+ " VALUES("+pedido.getId()+",'"+pedido.getTipoEntrega()+"','"+pedido.getTipoPago()+"','"+pedido.getDepartamento()+"','"+pedido.getProvincia()+"','"+pedido.getDistrto()+"','"+pedido.getDireccion().toUpperCase()+"','"+pedido.getReferencia()+"','"+pedido.getTelefono1()+"','"+pedido.getTelefono2()+"','P',"+pedido.getCuota()+","+pedido.getCargo_entrega()+");";
